...
const Overview = (props) => {
  ...
  const [isClickedAnnouncement, setIsClickedAnnouncement] = useState(false)
  ...
  return (
    <div className='grid items-center flex-1 w-full grid-cols-12'>
      ...
      <ViewAnnouncementModal
        isOpen={isClickedAnnouncement}
        setIsOpen={setIsClickedAnnouncement}
        title={announcementDetails.title}
        content={announcementDetails.content}
        createdAt={announcementDetails.createdAt}
      />
        ...
        <main className='relative flex flex-col flex-1 w-full pt-3 '>
          ...
          <section className='flex flex-col items-center w-full mt-3 gap-y-3 gap-x-8'>
            ...
            <div className='grid grid-cols-4 gap-x-11 gap-y-4'>
              {props.subjectInformation.announcements.map(
                (announcement) => {
                  return (
                    <SubjectAnnouncement
                      onClick={() => {
            ...
            {!loading &&
              props.subjectInformation.teacher._id == session.user._id && (
                <div className='flex mt-3 mb-4 gap-x-2'>
                  <FilledButton
