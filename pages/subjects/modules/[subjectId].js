...
const Overview = (props) => {
  ...
  console.log(props.subjectInformation)
  return (
      ...
      <div className="flex flex-col w-full h-full col-span-12 bg-WSAI-Indigo-25">
        ...
        <main className="relative flex flex-col flex-1 w-full pt-3 ">
          <section className="grid grid-cols-2 px-32 gap-y-8 gap-x-16">
            {props.subjectInformation.modules && props.subjectInformation.modules.map((module) => {
              return (
                <a href={module.attachedFile} key={module._id} target="_blank" rel="noreferrer" className={`w-full h-52 ${styles.moduleBg1} justify-self-center flex flex-col p-6 rounded-md overflow-hidden focus:outline-none focus:ring`}>
          ...
          <div className="flex justify-center mt-3 gap-x-2">
            <BorderedButton>Add Task</BorderedButton>
            <FilledButton
