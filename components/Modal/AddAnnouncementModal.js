...
export default function AddAnnouncementModal({ isOpen, setIsOpen, subjectId }) {
  ...
  const handleSubmit = (e) => {
    ...
    saveData(`${process.env.BASE_URL}/api/announcements`, announcementDetail)
    resetFields()
    setIsOpen(false)
  }
          ...
          >
            ...
            >
              ...
              <div className='flex flex-col gap-y-1'>
                ...
                <textarea
                  onChange={(e) => handleChange(e)}
                  value={announcementDetail.content}
                  required
